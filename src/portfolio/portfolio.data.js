...
const getImageUrl = function(path, name) {
...
export const projects = [
...

  {
    ...
    preview:      {
      ...
      // image:  getImageUrl('../assets/portfolio/rocket/ironbear', 'thumb.png'),
      type:   'product',
      color:  'lightcoral'
    },
...
//     let filteredProjects = _.orderBy(
//       _.filter(projects, o => { return !o.hidden; }),
//       [ 'year' ],
//       [ 'desc' ]);
...
//       data[value.slug] = {
//         projects: _.filter(filteredProjects, o => { return o.company.slug == value.slug; }),
//       }
//     });
