<template>
  <PortfolioPage>
    ...
    <template v-slot:process>
      ...
      <Illustration :imagesrc="require(`./dead-end.png`)">
      ...
      <Illustration :imagesrc="require(`./photo.jpg`)">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        news: _.filter(newsData, ['project', 'RocketIronbear'])
      }
    }
  }
</script>
