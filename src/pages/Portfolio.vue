<template>
  <Subpage>
    ...
    <section id="menu">
      <router-link :to="{ hash: '#rocket' }" alt="Rocket" class="rocket"><img src="../assets/rocket.png"></router-link>
      <router-link :to="{ hash: '#amazon' }" alt="Amazon" class="amazon"><img src="../assets/amazon.png"></router-link>
      <router-link :to="{ hash: '#disney' }" alt="Disney" class="disney"><img src="../assets/disney.png"></router-link>
      <router-link :to="{ hash: '#phenomblue' }" alt="Phenomblue" class="phenomblue"><img src="../assets/phenomblue.png"></router-link>
    </section>
